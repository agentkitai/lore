...
def _format_extraction_prompt(
    *,
    ...
    return (
        ...
        "\n"
        "  1. mcp__lore__remember_observation(\n"
        ...
        "     where you have a headline, a few atomic facts, and prose.\n"
        "\n"
        "  2. mcp__lore__remember(\n"
        "         content=\"<short, self-contained>\",\n"
        "         type=\"<one of: lesson, fact, preference, pattern, convention, note>\"\n"
        "     )\n"
        ...
        "  - Typical batch: 0-3 observations OR 0-1 polished memories.\n"
